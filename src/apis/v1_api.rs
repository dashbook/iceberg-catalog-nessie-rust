...
use crate::{
    ...
    models::{FetchOption, Namespace, ReferenceType},
};
...
pub async fn assign_reference(
    configuration: &configuration::Configuration,
    reference_name: &str,
    reference_type: ReferenceType,
    expected_hash: &str,
    reference: Option<crate::models::Reference>,
) -> Result<(), Error<AssignReferenceError>> {
    ...
    let local_var_uri_str = format!(
        ...
        referenceName = crate::apis::urlencode(reference_name),
    ...
    local_var_req_builder =
        local_var_req_builder.query(&[("expectedHash", &expected_hash.to_string())]);
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<AssignReferenceError> =
...
pub async fn commit_multiple_operations(
    configuration: &configuration::Configuration,
    branch_name: &str,
    expected_hash: Option<&str>,
    operations: Option<crate::models::Operations>,
) -> Result<crate::models::BranchV1, Error<CommitMultipleOperationsError>> {
    let local_var_configuration = configuration;
    ...
    let local_var_uri_str = format!(
        ...
        local_var_configuration.base_path,
        branchName = crate::apis::urlencode(branch_name)
    );
    let mut local_var_req_builder =
    ...
    if let Some(ref local_var_str) = expected_hash {
        local_var_req_builder =
            local_var_req_builder.query(&[("expectedHash", &local_var_str.to_string())]);
    }
    if let Some(ref local_var_user_agent) = local_var_configuration.user_agent {
        local_var_req_builder =
            local_var_req_builder.header(reqwest::header::USER_AGENT, local_var_user_agent.clone());
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<CommitMultipleOperationsError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn create_namespace(
    ...
    name: Namespace,
    r#ref: &str,
    hash_on_ref: Option<&str>,
    namespace: Option<crate::models::Namespace>,
) -> Result<crate::models::NamespaceV1, Error<CreateNamespaceError>> {
    let local_var_configuration = configuration;
    ...
    if let Some(ref local_var_str) = hash_on_ref {
        local_var_req_builder =
            local_var_req_builder.query(&[("hashOnRef", &local_var_str.to_string())]);
    }
    if let Some(ref local_var_user_agent) = local_var_configuration.user_agent {
        local_var_req_builder =
            local_var_req_builder.header(reqwest::header::USER_AGENT, local_var_user_agent.clone());
...
pub async fn create_reference(
    ...
    reference: Option<crate::models::Reference>,
) -> Result<crate::models::ReferenceV1, Error<CreateReferenceError>> {
    let local_var_configuration = configuration;
    ...
    if let Some(ref local_var_str) = source_ref_name {
        local_var_req_builder =
            local_var_req_builder.query(&[("sourceRefName", &local_var_str.to_string())]);
    }
    if let Some(ref local_var_user_agent) = local_var_configuration.user_agent {
        local_var_req_builder =
            local_var_req_builder.header(reqwest::header::USER_AGENT, local_var_user_agent.clone());
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<CreateReferenceError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn delete_reference(
    ...
    reference_type: ReferenceType,
    expected_hash: &str,
) -> Result<(), Error<DeleteReferenceError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<DeleteReferenceError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn get_all_references(
...
) -> Result<crate::models::ReferencesResponseV1, Error<GetAllReferencesError>> {
    let local_var_configuration = configuration;
    ...
    if let Some(ref local_var_str) = max_records {
        local_var_req_builder =
            local_var_req_builder.query(&[("maxRecords", &local_var_str.to_string())]);
    }
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<GetAllReferencesError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn get_commit_log(
...
) -> Result<crate::models::LogResponseV1, Error<GetCommitLogError>> {
    let local_var_configuration = configuration;
    ...
    if let Some(ref local_var_str) = end_hash {
        local_var_req_builder =
            local_var_req_builder.query(&[("endHash", &local_var_str.to_string())]);
    }
    if let Some(ref local_var_str) = fetch {
        local_var_req_builder =
            local_var_req_builder.query(&[("fetch", &local_var_str.to_string())]);
    ...
    if let Some(ref local_var_str) = start_hash {
        local_var_req_builder =
            local_var_req_builder.query(&[("startHash", &local_var_str.to_string())]);
    }
    if let Some(ref local_var_user_agent) = local_var_configuration.user_agent {
        local_var_req_builder =
            local_var_req_builder.header(reqwest::header::USER_AGENT, local_var_user_agent.clone());
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<GetCommitLogError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn get_config(
    configuration: &configuration::Configuration,
) -> Result<crate::models::NessieConfigurationV1, Error<GetConfigError>> {
    let local_var_configuration = configuration;
...
pub async fn get_content(
    ...
    hash_on_ref: Option<&str>,
    r#ref: Option<&str>,
) -> Result<crate::models::ContentV1, Error<GetContentError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<GetContentError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn get_default_branch(
    configuration: &configuration::Configuration,
) -> Result<crate::models::BranchV1, Error<GetDefaultBranchError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<GetDefaultBranchError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn get_diff(
...
) -> Result<crate::models::DiffResponseV1, Error<GetDiffError>> {
    let local_var_configuration = configuration;
    ...
    let local_var_uri_str = format!(
        ...
        local_var_configuration.base_path,
        fromRefWithHash = crate::apis::urlencode(from_ref_with_hash),
        toRefWithHash = crate::apis::urlencode(to_ref_with_hash)
    );
    let mut local_var_req_builder =
        local_var_client.request(reqwest::Method::GET, local_var_uri_str.as_str());
...
pub async fn get_entries(
    ...
    hash_on_ref: Option<&str>,
    max_records: Option<i32>,
    namespace_depth: Option<i32>,
    page_token: Option<&str>,
) -> Result<crate::models::EntriesResponseV1, Error<GetEntriesError>> {
    let local_var_configuration = configuration;
    ...
    if let Some(ref local_var_str) = namespace_depth {
        local_var_req_builder =
            local_var_req_builder.query(&[("namespaceDepth", &local_var_str.to_string())]);
    }
    if let Some(ref local_var_str) = page_token {
        local_var_req_builder =
            local_var_req_builder.query(&[("pageToken", &local_var_str.to_string())]);
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<GetEntriesError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn get_multiple_contents(
    configuration: &configuration::Configuration,
    hash_on_ref: Option<&str>,
    r#ref: Option<&str>,
    get_multiple_contents_request: Option<crate::models::GetMultipleContentsRequest>,
) -> Result<crate::models::GetMultipleContentsResponseV1, Error<GetMultipleContentsError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<GetMultipleContentsError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn get_namespace(
    ...
    r#ref: &str,
    hash_on_ref: Option<&str>,
) -> Result<crate::models::NamespaceV1, Error<GetNamespaceError>> {
    let local_var_configuration = configuration;
...
) -> Result<crate::models::GetNamespacesResponseV1, Error<GetNamespacesError>> {
    let local_var_configuration = configuration;
...
pub async fn get_ref_log(
    ...
    page_token: Option<&str>,
    start_hash: Option<&str>,
) -> Result<serde_json::Value, Error<GetRefLogError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<GetRefLogError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn get_reference_by_name(
    ...
    r#ref: &str,
    fetch: Option<FetchOption>,
) -> Result<crate::models::ReferenceV1, Error<GetReferenceByNameError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<GetReferenceByNameError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn merge_ref_into_branch(
    configuration: &configuration::Configuration,
    branch_name: &str,
    expected_hash: &str,
    merge1: Option<crate::models::Merge1>,
) -> Result<crate::models::MergeResponseV1, Error<MergeRefIntoBranchError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<MergeRefIntoBranchError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn transplant_commits_into_branch(
    configuration: &configuration::Configuration,
    branch_name: &str,
    expected_hash: &str,
    message: Option<&str>,
    transplant1: Option<crate::models::Transplant1>,
) -> Result<crate::models::MergeResponseV1, Error<TransplantCommitsIntoBranchError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<TransplantCommitsIntoBranchError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn update_properties(
    ...
    r#ref: &str,
    hash_on_ref: Option<&str>,
    namespace_update: Option<crate::models::NamespaceUpdate>,
