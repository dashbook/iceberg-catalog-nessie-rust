...
pub async fn assign_reference_v2(configuration: &configuration::Configuration, r#ref: serde_json::Value, reference: crate::models::Reference, r#type: Option<ReferenceType>) -> Result<crate::models::SingleReferenceResponseV2, Error<AssignReferenceV2Error>> {
    let local_var_configuration = configuration;

    let local_var_client = &local_var_configuration.client;

    let local_var_uri_str = format!("{}/v2/trees/{ref}", local_var_configuration.base_path, ref=r#ref);
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<AssignReferenceV2Error> = serde_json::from_str(&local_var_content).ok();
...
pub async fn commit_v2(configuration: &configuration::Configuration, branch: serde_json::Value, operations: crate::models::Operations) -> Result<crate::models::CommitResponseV2, Error<CommitV2Error>> {
    let local_var_configuration = configuration;

    let local_var_client = &local_var_configuration.client;

    let local_var_uri_str = format!("{}/v2/trees/{branch}/history/commit", local_var_configuration.base_path, branch=branch);
...
pub async fn create_reference_v2(configuration: &configuration::Configuration, name: &str, r#type: ReferenceType, reference: crate::models::Reference) -> Result<crate::models::SingleReferenceResponseV2, Error<CreateReferenceV2Error>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<CreateReferenceV2Error> = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Err(Error::ResponseError(local_var_error))
    }
}
...
pub async fn delete_reference_v2(configuration: &configuration::Configuration, r#ref: serde_json::Value, r#type: Option<ReferenceType>) -> Result<crate::models::SingleReferenceResponseV2, Error<DeleteReferenceV2Error>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<DeleteReferenceV2Error> = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Err(Error::ResponseError(local_var_error))
    }
}

pub async fn get_all_references_v2(configuration: &configuration::Configuration, fetch: Option<FetchOption>, filter: Option<&str>, max_records: Option<i32>, page_token: Option<&str>) -> Result<crate::models::ReferencesResponseV2, Error<GetAllReferencesV2Error>> {
    let local_var_configuration = configuration;
    ...
    if let Some(ref local_var_str) = max_records {
        local_var_req_builder = local_var_req_builder.query(&[("max-records", &local_var_str.to_string())]);
    }
    if let Some(ref local_var_str) = page_token {
        local_var_req_builder = local_var_req_builder.query(&[("page-token", &local_var_str.to_string())]);
    }
    if let Some(ref local_var_user_agent) = local_var_configuration.user_agent {
        local_var_req_builder = local_var_req_builder.header(reqwest::header::USER_AGENT, local_var_user_agent.clone());
    }
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<GetAllReferencesV2Error> = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Err(Error::ResponseError(local_var_error))
    }
}
...
pub async fn get_commit_log_v2(configuration: &configuration::Configuration, r#ref: serde_json::Value, fetch: Option<FetchOption>, filter: Option<&str>, limit_hash: Option<&str>, max_records: Option<i32>, page_token: Option<&str>) -> Result<crate::models::LogResponseV2, Error<GetCommitLogV2Error>> {
    let local_var_configuration = configuration;

    let local_var_client = &local_var_configuration.client;

    let local_var_uri_str = format!("{}/v2/trees/{ref}/history", local_var_configuration.base_path, ref=r#ref);
    let mut local_var_req_builder = local_var_client.request(reqwest::Method::GET, local_var_uri_str.as_str());
    ...
    if let Some(ref local_var_str) = limit_hash {
        local_var_req_builder = local_var_req_builder.query(&[("limit-hash", &local_var_str.to_string())]);
    }
    if let Some(ref local_var_str) = max_records {
        local_var_req_builder = local_var_req_builder.query(&[("max-records", &local_var_str.to_string())]);
    }
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<GetCommitLogV2Error> = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Err(Error::ResponseError(local_var_error))
    }
}

pub async fn get_config_v2(configuration: &configuration::Configuration, ) -> Result<crate::models::NessieConfigurationV2, Error<GetConfigV2Error>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<GetConfigV2Error> = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Err(Error::ResponseError(local_var_error))
    }
}
...
pub async fn get_content_v2(configuration: &configuration::Configuration, key: ContentKey, r#ref: serde_json::Value, with_doc: Option<bool>) -> Result<crate::models::ContentResponseV2, Error<GetContentV2Error>> {
    let local_var_configuration = configuration;
    ...
    if let Some(ref local_var_str) = with_doc {
        local_var_req_builder = local_var_req_builder.query(&[("with-doc", &local_var_str.to_string())]);
    }
    if let Some(ref local_var_user_agent) = local_var_configuration.user_agent {
        local_var_req_builder = local_var_req_builder.header(reqwest::header::USER_AGENT, local_var_user_agent.clone());
    }
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<GetContentV2Error> = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Err(Error::ResponseError(local_var_error))
    }
}
...
pub async fn get_diff_v2(configuration: &configuration::Configuration, from_ref: &str, to_ref: &str, filter: Option<&str>, key: Option<Vec<crate::models::ContentKey>>, max_key: Option<ContentKey>, max_records: Option<i32>, min_key: Option<ContentKey>, page_token: Option<&str>, prefix_key: Option<ContentKey>) -> Result<crate::models::DiffResponseV2, Error<GetDiffV2Error>> {
    let local_var_configuration = configuration;

    let local_var_client = &local_var_configuration.client;

    let local_var_uri_str = format!("{}/v2/trees/{from-ref}/diff/{to-ref}", local_var_configuration.base_path, from-ref=crate::apis::urlencode(from_ref), to-ref=crate::apis::urlencode(to_ref));
    let mut local_var_req_builder = local_var_client.request(reqwest::Method::GET, local_var_uri_str.as_str());
    ...
    if let Some(ref local_var_str) = max_key {
        local_var_req_builder = local_var_req_builder.query(&[("max-key", &local_var_str.to_string())]);
    }
    if let Some(ref local_var_str) = max_records {
        local_var_req_builder = local_var_req_builder.query(&[("max-records", &local_var_str.to_string())]);
    }
    if let Some(ref local_var_str) = min_key {
        local_var_req_builder = local_var_req_builder.query(&[("min-key", &local_var_str.to_string())]);
    }
    if let Some(ref local_var_str) = page_token {
        local_var_req_builder = local_var_req_builder.query(&[("page-token", &local_var_str.to_string())]);
    }
    if let Some(ref local_var_str) = prefix_key {
        local_var_req_builder = local_var_req_builder.query(&[("prefix-key", &local_var_str.to_string())]);
    }
    if let Some(ref local_var_user_agent) = local_var_configuration.user_agent {
        local_var_req_builder = local_var_req_builder.header(reqwest::header::USER_AGENT, local_var_user_agent.clone());
    }
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<GetDiffV2Error> = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Err(Error::ResponseError(local_var_error))
    }
}
...
pub async fn get_entries_v2(configuration: &configuration::Configuration, r#ref: serde_json::Value, content: Option<bool>, filter: Option<&str>, key: Option<Vec<crate::models::ContentKey>>, max_key: Option<ContentKey>, max_records: Option<i32>, min_key: Option<ContentKey>, page_token: Option<&str>, prefix_key: Option<ContentKey>) -> Result<crate::models::EntriesResponseV2, Error<GetEntriesV2Error>> {
    let local_var_configuration = configuration;

    let local_var_client = &local_var_configuration.client;

    let local_var_uri_str = format!("{}/v2/trees/{ref}/entries", local_var_configuration.base_path, ref=r#ref);
    let mut local_var_req_builder = local_var_client.request(reqwest::Method::GET, local_var_uri_str.as_str());
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<GetEntriesV2Error> = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Err(Error::ResponseError(local_var_error))
    }
}
...
pub async fn get_multiple_contents_v2(configuration: &configuration::Configuration, r#ref: serde_json::Value, with_doc: Option<bool>, get_multiple_contents_request: Option<crate::models::GetMultipleContentsRequest>) -> Result<crate::models::GetMultipleContentsResponseV2, Error<GetMultipleContentsV2Error>> {
    let local_var_configuration = configuration;

    let local_var_client = &local_var_configuration.client;

    let local_var_uri_str = format!("{}/v2/trees/{ref}/contents", local_var_configuration.base_path, ref=r#ref);
    let mut local_var_req_builder = local_var_client.request(reqwest::Method::POST, local_var_uri_str.as_str());
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<GetMultipleContentsV2Error> = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Err(Error::ResponseError(local_var_error))
    }
}

pub async fn get_reference_by_name_v2(configuration: &configuration::Configuration, r#ref: &str, fetch: Option<FetchOption>) -> Result<crate::models::SingleReferenceResponseV2, Error<GetReferenceByNameV2Error>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<GetReferenceByNameV2Error> = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Err(Error::ResponseError(local_var_error))
    }
}

pub async fn get_repository_config(configuration: &configuration::Configuration, r#type: Option<Vec<String>>) -> Result<crate::models::RepositoryConfigurationObjectsForTheRequestedTypes, Error<GetRepositoryConfigError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<GetRepositoryConfigError> = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Err(Error::ResponseError(local_var_error))
    }
}
...
pub async fn get_several_contents(configuration: &configuration::Configuration, r#ref: &str, key: Option<Vec<String>>, with_doc: Option<bool>) -> Result<crate::models::GetMultipleContentsResponseV2, Error<GetSeveralContentsError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<GetSeveralContentsError> = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Err(Error::ResponseError(local_var_error))
    }
}
...
pub async fn merge_v2(configuration: &configuration::Configuration, branch: serde_json::Value, merge: crate::models::Merge) -> Result<crate::models::MergeResponseV2, Error<MergeV2Error>> {
    let local_var_configuration = configuration;

    let local_var_client = &local_var_configuration.client;

    let local_var_uri_str = format!("{}/v2/trees/{branch}/history/merge", local_var_configuration.base_path, branch=branch);
    let mut local_var_req_builder = local_var_client.request(reqwest::Method::POST, local_var_uri_str.as_str());
...
pub async fn transplant_v2(configuration: &configuration::Configuration, branch: serde_json::Value, transplant: crate::models::Transplant) -> Result<crate::models::MergeResponseV2, Error<TransplantV2Error>> {
    let local_var_configuration = configuration;

    let local_var_client = &local_var_configuration.client;

    let local_var_uri_str = format!("{}/v2/trees/{branch}/history/transplant", local_var_configuration.base_path, branch=branch);
    let mut local_var_req_builder = local_var_client.request(reqwest::Method::POST, local_var_uri_str.as_str());
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<TransplantV2Error> = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Err(Error::ResponseError(local_var_error))
    }
}

pub async fn update_repository_config(configuration: &configuration::Configuration, ) -> Result<crate::models::ThePreviousStateOfTheRepositoryConfigurationObject, Error<UpdateRepositoryConfigError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<UpdateRepositoryConfigError> = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Err(Error::ResponseError(local_var_error))
    }
}
