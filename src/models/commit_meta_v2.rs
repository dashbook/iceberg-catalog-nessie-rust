...
impl CommitMetaV2 {
    pub fn new(authors: Vec<String>, all_signed_off_by: Vec<String>, message: String, all_properties: ::std::collections::HashMap<String, Vec<String>>, parent_commit_hashes: Vec<String>) -> CommitMetaV2 {
        CommitMetaV2 {
            hash: None,
            committer: None,
            authors,
