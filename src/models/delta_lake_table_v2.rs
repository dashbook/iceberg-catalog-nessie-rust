...
impl DeltaLakeTableV2 {
    pub fn new(metadata_location_history: Vec<String>, checkpoint_location_history: Vec<String>) -> DeltaLakeTableV2 {
        DeltaLakeTableV2 {
            id: None,
