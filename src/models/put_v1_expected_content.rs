...
pub struct PutV1ExpectedContent {
...
impl PutV1ExpectedContent {
    pub fn new(metadata_location: String, metadata_location_history: Vec<String>, checkpoint_location_history: Vec<String>, sql_text: String, elements: Vec<String>, properties: ::std::collections::HashMap<String, String>) -> PutV1ExpectedContent {
